@echo off
echo ========================================
echo   OCPP 1.6 Server v2.3.0 - Starting...
echo ========================================
echo.
...
echo ✅ Server version: v2.3.0 (OCPP 1.6 Protocol)
...
echo 🚀 Starting OCPP 1.6 Server v2.3.0...
python start_server.py

echo.
echo 🛑 Server stopped.
echo Thank you for using OCPP 1.6 Server v2.3.0!
pause 