@echo off
echo ========================================
echo   OCPP 1.6 Server v2.0.0 - Starting...
echo ========================================
echo.
...
echo ✅ Server version: v2.0.0 (OCPP 1.6 Protocol)
...
echo 🚀 Starting OCPP 1.6 Server v2.0.0...
python -m backend.main

echo.
echo 🛑 Server stopped.
echo Thank you for using OCPP 1.6 Server v2.0.0!
pause 